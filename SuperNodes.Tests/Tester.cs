...
public static class Tester {
  /// <summary>
  /// Minimal super node attribute for injection during testing. Without
  /// injecting this code, attribute symbols don't resolve.
  /// </summary>
  public const string SUPER_NODE_ATTRIBUTE = """
  [AttributeUsage(AttributeTargets.Class)]
  public class SuperNodeAttribute : Attribute {
    public object[] Args { get; }
    public SuperNodeAttribute(params object[] args) => Args = args;
  }
  """;
